...
export default function UsuarioEditor({ mostraUsuarios }) {
    ...
    async function salvaUsuario() {
        ...
        await AsyncStorage.setItem(umUsuario.id, umUsuario.texto)
        mostraUsuarios()
    }
                ...
                <View style={estilos.centralizaModal}>
                    <ScrollView showsVerticalScrollIndicator={false}>
                        <View style={estilos.modal}>
                            <Text style={estilos.modalTitulo}>Criar Usuario</Text>
                            <Text style={estilos.modalSubTitulo}>Informe o Nome do Usuario</Text>
                            <TextInput
                            ...
                            <View style={estilos.modalBotoes}>
                                <TouchableOpacity style={estilos.modalBotaoSalvar} onPress={() => { salvaUsuario() }}>
